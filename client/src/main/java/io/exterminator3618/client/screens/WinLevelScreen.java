...
public final class WinLevelScreen implements Screen {
    ...
    public WinLevelScreen(Exterminator3618 game, int level) {
        ...
        final int NEXT_Y = PLAY_Y - Constants.BUTTON_HEIGHT - 20;
        ...
        nextLevelButton = new TextButton("Next Level", CENTER_X, NEXT_Y, Constants.BUTTON_WIDTH, Constants.BUTTON_HEIGHT, true);
        box = new Box(800,500,"WIN LEVEL " + level);
    ...
    public void render(float delta) {
        ...
        if (Gdx.input.justTouched()) {
            ...
            if (nextLevelButton.isClicked(touchPos.x, touchPos.y)) {
